...
from app.schemas.api.v1.roles_schemas import GetUserRolesResponseSchema, AssignUserRoleResponseSchema, \
...
async def get_user_roles(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST, detail='Пользователя с таким id не существует.'
        )
...
async def assign_user_role(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST, detail='Роли с таким id не существует.'
        )
