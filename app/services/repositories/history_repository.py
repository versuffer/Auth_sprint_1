...
from app.db.postgres.models.users import UserModel, HistoryModel
from app.schemas.api.v1.auth_schemas import HistorySchemaCreate
from app.schemas.services.repositories.history_repository_schemas import UserHistoryDBSchema
